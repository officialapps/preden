  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-b from-[#0B1426] to-[#01042c] flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center space-y-16">
        ...
        {/* STIM Logo with Background Glow */}
        <div className="relative">
          ...
          <div className="relative w-32 h-32 md:w-40 md:h-40 flex items-center justify-center">
            <img 
              src={STIM} 
              alt="STIM" 
              className="w-24 h-32 md:w-32 md:h-40 object-contain drop-shadow-lg"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          {/* Loading text */}
          <p className="text-cyan-400 text-lg font-medium">Stimming...</p>
