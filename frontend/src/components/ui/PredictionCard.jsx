...
const PredictionCard = ({
  ...
  return (
    <div className={`bg-[#09113b] rounded-xl ${showBorder ? 'border border-[#18DDF7]' : ''} px-4 py-2 mt-2 mb-6`}>
      {/* Question Header */}
      ...
      <div className="mb-2">
        <div className="relative w-full h-10 rounded-full bg-[#18DDF71A] overflow-hidden">
          ...
          <div className="absolute inset-y-0 left-5 flex items-center gap-2 text-white font-semibold">
            <span>{optionA}</span>
            <img src={Up} alt="Up Icon" className="w-4 h-4" />
          </div>
          {/* Percentage */}
          <div className="absolute inset-y-0 right-2 flex items-center text-white font-semibold">
